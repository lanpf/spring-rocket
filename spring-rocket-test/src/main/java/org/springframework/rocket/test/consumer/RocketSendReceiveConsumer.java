...
@Slf4j
@Component
public class RocketSendReceiveConsumer {

    public final static String KEY = "rocket-send-receive";
    public final static String GROUP_ID = "GID_ROCKET_SEND_RECEIVE";


    @RocketListener(topic = KEY, concurrency = "false", groupId = GROUP_ID)
    @RocketHandler
    public PayloadReceive onMessage(@Payload PayloadReceive payload,
