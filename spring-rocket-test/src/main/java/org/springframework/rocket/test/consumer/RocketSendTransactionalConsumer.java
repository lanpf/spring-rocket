...
@Slf4j
@Component
public class RocketSendTransactionalConsumer {

    public final static String KEY = "rocket-send-transaction";
    public final static String GROUP_ID = "GID_ROCKET_SEND_TRANSACTION";
