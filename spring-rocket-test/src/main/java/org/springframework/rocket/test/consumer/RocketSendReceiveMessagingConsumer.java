...
@Slf4j
@Component
public class RocketSendReceiveMessagingConsumer {

    public final static String KEY = "rocket-send-receive-messaging";
    public final static String GROUP_ID = "GID_ROCKET_SEND_RECEIVE_MESSAGING";


    @RocketListener(topic = KEY, concurrency = "false", groupId = GROUP_ID)
    @RocketHandler
    public Message<PayloadReceive> onMessage(@Payload PayloadReceive payload,
