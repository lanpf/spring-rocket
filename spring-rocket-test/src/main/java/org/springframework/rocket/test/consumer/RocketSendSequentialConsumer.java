...
@Slf4j
@Component
public class RocketSendSequentialConsumer {

    public final static String KEY = "rocket-send-sequential";
    public final static String GROUP_ID = "GID_ROCKET_SEND_SEQUENTIAL";
